...
@section('main')
    ...
    <div class="row">
        <div class="col-lg-12 my-3">
            <h2><a href="/dashboard/types"><i class="ti ti-arrow-left"></i></a> Edit Genre Buku</h2>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="desc" id="" cols="160" rows="10" class="form-control">{{ old('desc', $type->desc) }}</textarea>
                                    @error('desc')
                                        <p class="invalid" style="color: red">
                                            {{ $message }}
                                        </p>
