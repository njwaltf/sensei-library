            ...
            <tbody>
                @forelse ($books as $item)
                    <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">{{ $item->writer }}</h6>
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">{{ $item->publisher }}</h6>
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">{{ $item->type->name }}</h6>
                        </td>
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">{{ $item->stock }}</h6>
                        </td>
                        <td class="border-bottom-0">
